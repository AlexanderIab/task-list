...
public class UserController {
    ...
    public UserDto getById(@PathVariable("id") final Long id) {
    ...
    @PreAuthorize("@customSecurityExpression.canAccessUser(#id)")
    public List<TaskDto> getTasksByUserId(@PathVariable("id") final Long id) {
    ...
    @PreAuthorize("@customSecurityExpression.canAccessUser(#id)")
    public TaskDto createTask(@PathVariable("id") final Long id,
